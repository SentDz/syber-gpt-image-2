...
- 生图尺寸只允许使用下方白名单
- 前端只展示分辨率选项，不再将清晰度和比例拆成两个选择
- 直接传入尺寸字符串时，也必须是白名单中的精确值

常用映射：

| 分辨率 | 标注 |
|---|---|
| `1024x1024` | `1K` / 正方形社交媒体头像、图标、标准卡片最常用默认尺寸，生成最快 |
| `1536x1024` | `2K` / 横向横幅、海报、演示文稿、产品展示官方推荐横向 2K |
| `1024x1536` | `2K` / 纵向手机壁纸、故事、竖版海报官方推荐纵向 2K |
| `2048x2048` | `2K` / 高清正方形海报、艺术图原生 2K 正方形 |
| `2048x1152` | `2K` / 横向 16:9 横幅、视频封面、宽屏经典 16:9 比例 2K |
| `3840x2160` | `4K` / 横向超高清横幅、4K 壁纸、印刷官方推荐最高规格横向 |
| `2160x3840` | `4K` / 纵向手机 4K 壁纸、竖版超清官方推荐最高规格纵向 |
